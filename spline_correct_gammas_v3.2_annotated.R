...
#' experimental lengths. The function returns the corrected condition-specific changes in fitnesses and a summary table for each bin.
#' 
...
correct_l2fc_3 <- function(initial_gammas, other_gammas, window_number = 10000, norm_to_constant = NA){
  ...
  return(list(results, corrected_other))
